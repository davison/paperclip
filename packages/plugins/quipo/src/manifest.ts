...
const manifest: PaperclipPluginManifestV1 = {
  ...
  displayName: "Quipo",
  description:
    "Cross-issue memory plugin. Stores extracted facts, session summaries, and peer models in a plugin-owned ctx.db schema. Per-company settings page enables/disables ingestion, picks the Memory Agent, and toggles extraction scope.",
  author: "Paperclip",
